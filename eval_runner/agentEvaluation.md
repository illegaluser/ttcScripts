...
- **파라미터 설명**:
  ...
  - `JUDGE_MODEL`: 심판 모델명 문자열입니다. 실행 전에 `OLLAMA_BASE_URL/api/tags`와 대조 검증합니다. 예: `qwen3-coder:30b`, `qwen2:7b`
